...
describe('Search Groups', () => {
    ...
    it("should search userJoinedGroups with Alice's token and get her Groups", async (done) => {
        ...
        expect(res.body[0].className).toEqual(Group1.className);
    ...
    it("should search userJoinedGroups with Alice's token and Carol's email and get Carol's Groups", async (done) => {
        ...
        expect(res.body[0].className).toEqual(Group2.className);
    ...
    it('should search cse210 and get back CSE210 Groups', async (done) => {
        ...
        expect(res.body[1].className).toEqual(Group2.className);
...
describe('Search Groups Responds with Ordered Array', () => {
    ...
    it('should search cse210 and get back CSE210 Groups ordered by start date', async (done) => {
        ...
        expect(res.body[1].className).toEqual(Group1.className);
        done();
    });
});